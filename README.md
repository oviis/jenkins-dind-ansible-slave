...
To run a Docker container.
    ...
    docker run --privileged=true oviis/jenkins-dind-ansible-slave:v1 -url http://jenkins-server:port <secret> <slave name> 
...
the Image have also a git ansible, for building into slave docker and ansible 
